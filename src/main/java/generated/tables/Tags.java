...
public class Tags extends TableImpl<TagsRecord> {
	...
	/**
	 * The column <code>public.tags.recieve_id</code>.
	 */
	public final TableField<TagsRecord, Integer> RECIEVE_ID = createField("recieve_id", org.jooq.impl.SQLDataType.INTEGER, this, "");
