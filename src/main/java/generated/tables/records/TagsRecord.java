...
public class TagsRecord extends TableRecordImpl<TagsRecord> implements Record4<Integer, Time, Integer, String> {

	private static final long serialVersionUID = 508804810;
	...
	/**
	 * Setter for <code>public.tags.recieve_id</code>.
	 */
	public void setRecieveId(Integer value) {
		setValue(2, value);
	}

	/**
	 * Getter for <code>public.tags.recieve_id</code>.
	 */
	 ...
	 */
	public TagsRecord(Integer id, Time uploaded, Integer recieveId, String tagname) {
		super(Tags.TAGS);

		setValue(0, id);
		setValue(1, uploaded);
		setValue(2, recieveId);
		setValue(3, tagname);
	}
}
